<div class="row mx-2">
    <div class="col d-flex justify-content-end">
        <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#tambah_data_user">
                        ...
                        <tbody>
                            @foreach ($user as $item)
                                <tr>
                                    ...
                                    <td class="text-xs text-secondary mb-0">{{ $item->email ?? '' }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn btn-sm mb-0 ms-2 btn-danger btn-delete-user"
                                            data-bs-target="#delete_data_user" data-id="{{ $item->id }}"
